...
export default function Topbar({ onMenu }) {
  ...
  return (
    <header className="no-print sticky top-0 z-30 flex items-center justify-between px-4 h-16 bg-white dark:bg-slate-800 border-b border-brand-200 dark:border-slate-700">
